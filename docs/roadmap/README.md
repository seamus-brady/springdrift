...
| [Remembrancer](planned/remembrancer.md) | Memory |
...
| [Commitment tracker](planned/commitment-tracker.md) | Work management |
| [OAuth authentication](planned/oauth-authentication.md) | Interfaces |
| [Web GUI v2](planned/web-gui-v2.md) | Interfaces |
| [Skills management](planned/skills-management.md) | Skills |
