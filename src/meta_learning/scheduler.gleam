...
////
//// Only judgement jobs run here: consolidation (weekly narrative
//// synthesis), goal review, skill decay, strategy review. The three
//// mechanical audits (affect correlation, fabrication audit, voice
//// drift) moved to dedicated BEAM workers in `meta_learning/worker.gleam`
//// so they never interrupt an active operator chat.
////
